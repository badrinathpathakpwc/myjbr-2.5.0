...
let envVariables = {
  LEARNER_URL: env.sunbird_learner_player_url || 'https://knowledgeshare.ddns.net/api/',
  CONTENT_URL: env.sunbird_content_player_url || 'https://knowledgeshare.ddns.net/api/',
  CONFIG_URL: env.sunbird_config_service_url || 'https://knowledgeshare.ddns.net/api/config/',
  ...
  PORTAL_AUTH_SERVER_URL: env.sunbird_portal_auth_server_url || 'https://knowledgeshare.ddns.net/auth',
  ...
  DATASERVICE_URL: env.sunbird_dataservice_url || 'https://knowledgeshare.ddns.net/api/',
  ...
  DEVICE_PROFILE_API: process.env.sunbird_device_profile_api || 'https://knowledgeshare.ddns.net/api/v3/device/profile/',
