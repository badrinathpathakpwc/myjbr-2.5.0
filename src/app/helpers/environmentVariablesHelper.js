...
let envVariables = {
  LEARNER_URL: env.sunbird_learner_player_url || 'https://myjbr.flexresourcemanagement.com/api/',
  CONTENT_URL: env.sunbird_content_player_url || 'https://myjbr.flexresourcemanagement.com/api/',
  CONFIG_URL: env.sunbird_config_service_url || 'https://myjbr.flexresourcemanagement.com/api/config/',
  CONFIG_REFRESH_INTERVAL: env.config_refresh_interval || 10,
  CONFIG_SERVICE_ENABLED: env.config_service_enabled || false,
  CONTENT_PROXY_URL: env.sunbird_content_proxy_url || 'https://knowledgeshare.ddns.net',
  PORTAL_REALM: env.sunbird_portal_realm || 'sunbird',
  PORTAL_AUTH_SERVER_URL: env.sunbird_portal_auth_server_url || 'https://myjbr.flexresourcemanagement.com/auth',
  ...
  PORTAL_ECHO_API_URL: env.sunbird_echo_api_url || 'https://myjbr.flexresourcemanagement.com/api/echo/',
  ...
  DATASERVICE_URL: env.sunbird_dataservice_url || 'https://myjbr.flexresourcemanagement.com/api/',
  ...
  sunbird_content_editor_artifact_url:'https://sunbirddev.blob.core.windows.net/sunbird-content-dev/artefacts/editor/content-editor-iframe-2.5.0.zip',
  sunbird_collection_editor_artifact_url:'https://sunbirddev.blob.core.windows.net/sunbird-content-dev/artefacts/editor/collection-editor-iframe-2.5.0.zip',
  sunbird_generic_editor_artifact_url:'https://sunbirddev.blob.core.windows.net/sunbird-content-dev/artefacts/editor/generic-editor-iframe-2.5.0.zip',
  ...
  AZURE_ACCOUNT_NAME: env.julia_azure_account_name || 'pzigxpcinslef20p008',
  ...
  DEVICE_PROFILE_API: process.env.sunbird_device_profile_api || 'https://myjbr.flexresourcemanagement.com/api/v3/device/profile/',
